 ...
 *  这三个方法：
 *    第一个方法，不用想肯定最慢，又转字符串，又使用 reverse 方法
 *    第二个方法，除了转字符串，其它的就是一些简单的运算，比第一个方法快得多
 *    第三个方法，不用转字符串，纯数字运算，比第二个方法稍快，但相差不多，在同一个量级
 *      - 还有一个原因，计算机本身，设计之初，就是用来计算用的，数字运算可以说是计算机最根本的功能，所以这里更快也是合理的
 *      - 由此也能得到启发，在算法中，能用数字运算的就不要转其它的变量类型或数据结构，数字运算是最快的！
 *    所以综合来看，还是第三个方法最好，推荐！
 */
